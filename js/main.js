...
(()=>{
 ...
 function popupSildeshow(){
  ...
  popupImg.onload = () =>{
    ...
    //deactive loaderafter the popupImg loaded
 ...
 function poppupDetails(){

  //if portfolio-item-details not exists
  if(!portfolioItems[itemIndex].querySelector('.portfolio-item-details')){

    projectDetailsBtn.style.display='none';
    return;/**end function exeution */
  }
 ...
 function poppupDetailsToggle(){
  if(projectDetailsContainer.classList.contains('active')){
    ...
    popup.scrollTo(0,projectDetailsContainer.offsetTo)
  }
